...
# Iterar sobre los valores enteros de x en el rango [-9, 9]
for x in range(-9, 10):  #
    # Evaluar la función f(x) = x^2 - 6x + 3
    valor = x**2 - 6*x + 3
    
    # Comparar el resultado con min_f. Si es menor, actualizar min_f y min_x
    if valor < min_f:
        min_f = valor
        min_x = x
