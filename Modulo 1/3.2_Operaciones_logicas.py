...
todos_positivos = num1 == num2 == num3
...
print("¿Los tres números son positivos?", todos_positivos)
print("¿Al menos uno de los números es negativo?", al_menos_un_negativo)
print("¿El primer número es mayor que el segundo y el segundo es mayor que el tercero?", orden)
